        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-center">
          ...
          <div className="w-full md:w-3/5" data-animate="fade-in">
           ...
           Over the years, that insight led me to forge my own path: one defined by exponential growth, freedom, and meaningful impact.
            ...
            <p className="text-gray-700 text-lg mb-8 font-inter">Today, my mission is simple yet powerful: to help real estate investors scale their coaching programs, boost revenue, and buy back their time. I understand the psychology behind high-value decisions and how to empower and guide high-intent leads toward profitable opportunities in the real estate investing space.</p>
