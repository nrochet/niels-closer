      ...
      <div className="container px-4 sm:px-6">
        <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-center">
          ...
          <div className="w-full md:w-3/5" data-animate="fade-in">
           ...
           <p className="text-gray-700 text-lg mb-6 font-inter">Born and raised in France, I moved to the U.S. in pursuit of the American dream, earning a world-class education at one of the most prestigious institutions in the nation, UC Berkeley. Yet the most valuable lesson wasn’t in the lecture halls. It was realizing that following the golden traditional corporate path meant settling for less than my full potential. Then it clicked. </p>
           ...
           Over the years, that insight led me to forge my own path: one defined by exponential growth, freedom, and meaningful impact.
            ...
            <p className="text-gray-700 text-lg mb-8 font-inter">Today, my mission is simple yet powerful: to help growth-driven entrepreneurs, coaches, and investors scale their coaching programs, boost revenue, and buy back their time. I understand the psychology behind high-value decisions and how to empower and guide high-intent leads toward profitable opportunities in the real estate investing space.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
              <div className="flex flex-col p-6 bg-resume-lightgrey rounded-lg shadow-sm transition-all hover:shadow-md h-full">
                ...
                <p className="text-gray-600 text-sm text-left">5+ years closing deals priced $60k-$80k through ROI-driven consultations.</p>
              </div>
